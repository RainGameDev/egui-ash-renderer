...
The image view of a custom texture must use an `R8G8B8A8_UNORM` format, i.e. the image must store gamma (sRGB) encoded
premultiplied-alpha data. The fragment shader decodes the sampled values to linear space itself. The managed textures
